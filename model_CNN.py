...
path1 = 'F:/Softech Solution Code/Land Classification Code/Land Classification100% code/dataset/agricultural'    #path of folder of images    
path2 = 'F:/Softech Solution Code/Land Classification Code/Land Classification100% code/test_set/2'  #path of folder to save images    
